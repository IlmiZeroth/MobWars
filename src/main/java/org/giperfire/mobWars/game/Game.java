...
public class Game {
    private final org.giperfire.mobWars.admin.Map map;
    ...
    public Game(final List<Player> playerList, org.giperfire.mobWars.admin.Map map){
    ...
    private void endTheGame(){
        ...
        SignController.updateSignForMap(this.map, 0);
    }
    ...
    public Scoreboard prepareScoreboard(Scoreboard gameScoreboard){
        ...
        // Правила видимости (можно настроить по желанию)
    ...
    private void changeSigns(Map map) {
        map.setBusy(true);
        SignController.updateSignForMap(map, currentPlayers);
    }
