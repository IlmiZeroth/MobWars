...
import org.giperfire.mobWars.game.Game;
import org.giperfire.mobWars.game.GameTeam;

import javax.annotation.Nullable;

public class BedrockMob extends EntityZombie implements BlockMob {
    ...
    private static final double cost = 5120;
    private static final double paydayIncrease = (double) 120/4;
    private static final double cooldown = 300;
    ...
    public BedrockMob(Location location, Location targetLoc, GameTeam team){
...
//        this.h(GenericAttributes.e).a(2.5); //attack speed
    ...
    public boolean spawnMob(){
        try {
            ...
            glass.setBaby();
            glass.setMetadata("mobType", new FixedMetadataValue(MobWars.getInstance(), "bedrockBlock"));
            this.entity = glass;
            EntityTracker tracker = BetterModel.model("bedrock")
    ...
    public boolean c(WorldServer worldserver, net.minecraft.world.entity.Entity entity){
        BetterModel.registry(this.entity) //Gets tracker registry.
                .map(reg -> reg.tracker("bedrock")) //Gets tracker by it's name
