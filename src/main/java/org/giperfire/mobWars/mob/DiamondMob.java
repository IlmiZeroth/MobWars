...
public class DiamondMob extends EntityZombie implements BlockMob{
    private Entity entity;
    private final GameTeam team;
    private static final int baseDamage = 20;
    private static final double attackDamage = 6;
    private static final double attackSpeed = 1.8;
    private static final double moveSpeed = 0.15;
    private static final double maxHealth = 120;
    private static final double cost = 1280;
    private static final double paydayIncrease = (double) 100/4;
    private static final double cooldown = 150;
    ...
    public DiamondMob(Location location, Location targetLoc, GameTeam team){
...
//        this.h(GenericAttributes.e).a(1.8); //attack speed
    ...
    public boolean spawnMob(){
        try {
            ...
            glass.setBaby();
            glass.setMetadata("mobType", new FixedMetadataValue(MobWars.getInstance(), "diamondBlock"));
            this.entity = glass;
            EntityTracker tracker = BetterModel.model("diamond")
    ...
    public boolean c(WorldServer worldserver, net.minecraft.world.entity.Entity entity){
        BetterModel.registry(this.entity) //Gets tracker registry.
                .map(reg -> reg.tracker("diamond")) //Gets tracker by it's name
