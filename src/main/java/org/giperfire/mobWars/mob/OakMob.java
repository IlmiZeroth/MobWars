...
public class OakMob extends EntityPig implements BlockMob {
    ...
    private static final double maxHealth = 40;
    private static final double cost = 80;
    private static final double paydayIncrease = (double) 50/4;
    ...
    public OakMob(Location location, Location targetLoc, GameTeam team){
    ...
    public boolean spawnMob(){
        try {
            ...
            glass.setBaby();
            glass.setMetadata("mobType", new FixedMetadataValue(MobWars.getInstance(), "oakBlock"));
            this.entity = glass;
            EntityTracker tracker = BetterModel.model("oak")
