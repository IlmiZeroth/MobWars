...
public class SandMob extends EntityPig implements BlockMob{
    ...
    private static final double maxHealth = 15;
    private static final double cost = 25;
    private static final double paydayIncrease = (double) 20/4;
    ...
    public SandMob(Location location, Location targetLoc, GameTeam team){
    ...
    public boolean spawnMob(){
        try {
            ...
            glass.setBaby();
            glass.setMetadata("mobType", new FixedMetadataValue(MobWars.getInstance(), "sandBlock"));
            this.entity = glass;
            EntityTracker tracker = BetterModel.model("sand")
