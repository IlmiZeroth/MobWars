...
public class DirtMob extends EntityPig implements BlockMob {
    ...
    private static final double maxHealth = 25;
    private static final double cost = 40;
    private static final double paydayIncrease = (double) 30/4;
    ...
    public DirtMob(Location location, Location targetLoc, GameTeam team){
        ...
        this.ch.a(0, new PathfinderGoalMoveToLocation(
                this,
                targetLoc.getX(),
                targetLoc.getY(),
                targetLoc.getZ(),
    ...
    public boolean spawnMob(){
        try {
            ...
            glass.setBaby();
            glass.setMetadata("mobType", new FixedMetadataValue(MobWars.getInstance(), "dirtBlock"));
            this.entity = glass;
            EntityTracker tracker = BetterModel.model("dirt")
    ...
    //Hit sound to dirt Hit
    @Override
    protected SoundEffect e(DamageSource damagesource) {
        return SoundEffects.wP;
    }

    //Death sound to dirt break
    @Override
    protected SoundEffect f_() {
        return SoundEffects.wN;
    }

    //Ambient sound to dirt step
    @Override
