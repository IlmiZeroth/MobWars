...
public class ObsidianMob extends EntityZombie implements BlockMob{
    private Entity entity;
    private final GameTeam team;
    private static final int baseDamage = 25;
    private static final double attackDamage = 8;
    private static final double attackSpeed = 2;
    private static final double moveSpeed = 0.15;
    private static final double maxHealth = 200;
    private static final double cost = 2560;
    private static final double paydayIncrease = (double) 110/4;
    private static final double cooldown = 200;
    ...
    public ObsidianMob(Location location, Location targetLoc, GameTeam team){
...
//        this.h(GenericAttributes.e).a(2); //attack speed
    ...
    public boolean spawnMob(){
        try {
            ...
            glass.setBaby();
            glass.setMetadata("mobType", new FixedMetadataValue(MobWars.getInstance(), "obsidianBlock"));
            this.entity = glass;
            EntityTracker tracker = BetterModel.model("obsidian")
    ...
    public boolean c(WorldServer worldserver, net.minecraft.world.entity.Entity entity){
        BetterModel.registry(this.entity) //Gets tracker registry.
                .map(reg -> reg.tracker("obsidian")) //Gets tracker by it's name
