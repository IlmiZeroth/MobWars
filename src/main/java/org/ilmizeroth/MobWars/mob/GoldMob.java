...
public class GoldMob extends EntityZombie implements BlockMob {
    private Entity entity;
    private final GameTeam team;
    public static final int baseDamage = 15;
    private static final double attackDamage = 5 ;
    private static final double attackSpeed = 1;
    private static final double moveSpeed = 0.15;
    private static final double maxHealth = 50;
    private static final double cost = 640;
    private static final double paydayIncrease = (double) 90/4;
    private static final double cooldown = 120;
    ...
    public GoldMob(Location location, Location targetLoc, GameTeam team){
...
//        this.h(GenericAttributes.e).a(1); //attack speed
    ...
    public boolean spawnMob(){
        try {
            ...
            glass.setBaby();
            glass.setMetadata("mobType", new FixedMetadataValue(MobWars.getInstance(), "goldBlock"));
            this.entity = glass;
            EntityTracker tracker = BetterModel.model("gold")
    ...
    public boolean c(WorldServer worldserver, net.minecraft.world.entity.Entity entity){
        BetterModel.registry(this.entity) //Gets tracker registry.
                .map(reg -> reg.tracker("gold")) //Gets tracker by it's name
