...
public class CobblestoneMob extends EntityZombie implements BlockMob{
    ...
    private static final double moveSpeed = 0.125;
    private static final double maxHealth = 60;
    private static final double cost = 160;
    private static final double paydayIncrease = (double) 70/4;
    ...
    public CobblestoneMob(Location location, Location targetLoc, GameTeam team){
...
//        this.h(GenericAttributes.e).a(1.5); //attack speed
    ...
    public boolean spawnMob(){
        try {
            ...
            glass.setBaby();
            glass.setMetadata("mobType", new FixedMetadataValue(MobWars.getInstance(), "cobblestoneBlock"));
            this.entity = glass;
    ...
    public boolean c(WorldServer worldserver, net.minecraft.world.entity.Entity entity){
        BetterModel.registry(this.entity) //Gets tracker registry.
                .map(reg -> reg.tracker("cobblestone")) //Gets tracker by it's name
